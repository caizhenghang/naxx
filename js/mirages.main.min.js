...
(function() {
  var a = function(a) {
      ...
      e.onreadystatechange = function() {
          ...
          d.init(a),
          a.completeFunction(d)) : console.log("OwO data request was unsuccessful: " + e.status))
      }
      ;
      e.open("get", a.api, !0);
    //   e.send(null)
  ...
  a.prototype.init = function(a) {
      ...
      for (var b = '\n            <div class="OwO-logo"><span>' + a.logo + '</span></div>\n            <div class="OwO-body" style="' + a.style + '">', c = 0; c < this.packages.length; c++) {
          ...
          if ("biaoqing" === this.odata[this.packages[c]].type) {
              ...
              void 0 != window.devicePixelRatio && 1.49 <= window.devicePixelRatio && (k = f);
              ...
              for (e = this.odata[this.packages[c]],
              k = LocalConst.BASE_SCRIPT_URL + "usr/biaoqing/" + e.name + "/",
              n = e.suffix,
              void 0 != window.devicePixelRatio && 1.49 <= window.devicePixelRatio && (n = e.retinaSuffix),
              ...
              f = 0; f < l.length; f++) {
                  ...
                  "undefined" !== typeof h) {
                      ...
                      b += '\n                    <li class="OwO-item" title="' + q + '" ' + ('data-input="::' + e.name + ":" + m + '::"') + ">" + ('<img data-src="' + (k + m + n) + '" class="' + p + '" title="' + q + '">') + "</li>"
                  }
              }
          else
      ...
      for (b = {
          $jscomp$loop$prop$i$12$14: 0
      }; b.$jscomp$loop$prop$i$12$14 < this.packagesEle.children.length; b = {
          $jscomp$loop$prop$i$12$14: b.$jscomp$loop$prop$i$12$14
      },
...
$jscomp.polyfill = function(a, e, g, k) {
  if (e) {
      ...
      k = g[a];
      e = e(k);
      e != k && null != e && $jscomp.defineProperty(g, a, {
          configurable: !0,
          writable: !0,
          value: e
      })
...
$jscomp.polyfill("String.prototype.endsWith", function(a) {
  return a ? a : function(a, g) {
      ...
      a += "";
      void 0 === g && (g = e.length);
      for (var l = Math.max(0, Math.min(g | 0, e.length)), h = a.length; 0 < h && 0 < l; )
          if (e[--l] != a[--h])
              return !1;
      return 0 >= h
  }
...
(function(a, e, g) {
  ...
  a(g).ready(function() {
      ...
      a(e).bind("scroll", function(b) {
          b = a("#wrap");
          b.find("#nav").width() < k && (LocalConst.IS_MOBILE && l || !LocalConst.IS_MOBILE) && (a("#wrap.display-nav").find("#body").unbind("click"),
          b.removeClass("display-nav"),
          a("body").removeClass("display-nav"),
          a("#nav-toolbar").find(".side-toolbar").removeClass("show-read-settings"),
  ...
  var r = {}
    ...
    , fa = function() {
      a("#toggle-nav").off("click").on("click", function(b) {
          ...
          LocalConst.TOC_AT_LEFT ? c.toggleClass("hide-menu-tree") : (c.removeClass("display-menu-tree"),
          ...
          A() || setTimeout(function() {
              ...
              b.off("click").on("click", function(e) {
                  ...
                  LocalConst.TOC_AT_LEFT || (a("#wrap").removeClass("display-menu-tree"),
                  d.removeClass("display-menu-tree"));
                  f.removeClass("show-read-settings");
                  a("#footer").removeClass("display-nav");
                  e.preventDefault()
      ...
      a("#navbar-search").off("click").on("click", function(b) {
          if ("undefined" === typeof ExSearchConfig) {
              ...
              b.hasClass("show-navbar-search") ? (b.removeClass("show-navbar-search"),
              c.focusout()) : (b.addClass("show-navbar-search"),
              c.focus())
          }
      })
  }
    , ga = function() {
      a('a.dropdown-toggle[data-toggle="dropdown"]').off("click").on("click", function(c) {
          ...
          d && (d.hasClass("show") ? d.removeClass("show") : (b(),
          d.addClass("show"),
          setTimeout(function() {
              var b = a("#body, .navbar");
    ...
    , J = function() {
      if (LocalConst.ENABLE_PJAX)
          a("#comment-form").off("submit").on("submit", function(b) {
              var c = a(this)
                , d = c.find("#submit")
              ...
              if (null === n || "" === a.trim(n))
                  return alert(d.attr("data-empty-comment")),
                  !1;
              0 === c.find("#author").length && 0 === c.find("#url").length && (m = a('a[href$="profile.php"]').text(),
              b = g.location.origin);
              d.attr("disabled", "disabled").val(d.attr("data-posting"));
              var p = "newComment-" + L;
              L++;
              b = '<li itemscope="" itemtype="http://schema.org/UserComments" id="' + p + '" class="comment-body"><div class="comment-author" itemprop="creator" itemscope="" itemtype="http://schema.org/Person"><span itemprop="image"><img class="avatar" src="' + LocalConst.BASE_SCRIPT_URL + 'images/spinner.svg" alt="' + m + '" width="100" height="100"></span><cite class="fn color-main" itemprop="name"><a href="' + b + '" rel="external nofollow" target="_blank">' + m + '</a></cite></div><div class="comment-meta"><a href="javascript:void(0)"><time itemprop="commentTime" datetime="' + d.attr("data-now") + '">' + d.attr("data-now") + '</time></a><span id="' + p + '-status" class="comment-posting">' + d.attr("data-posting") + '</span></div><div class="comment-content" itemprop="commentText"><p>' + x(la(n), h.owoData) + "</p></div></li>";
              var v = n = !1
              ...
              v = !0),
              n = !0) : f.is("li") && f.hasClass("comment-body") && (f.parent().parent().is("div") && "comments" === f.parent().parent().attr("id") ? 0 < f.children(".comment-children").first().children(".comment-list").length ? f.children(".comment-children").first().children(".comment-list").first().append(b) : f.append('<div class="comment-children" itemprop="discusses"><ol class="comment-list">' + b + "</ol></div>") : f.parents(".comment-list").first().append(b),
              n = !0);
              if (n) {
                  var k = C();
                  try {
                      var N = a("#" + p).offset();
                      "undefined" !== typeof N && a("html, body").animate({
                          scrollTop: N.top - 50 - k
                      }, 300)
                  } catch (E) {
                      console.error(E)
                  }
                  var l = function() {
                      try {
                          v ? (f.children(".comment-separator").first().remove(),
                          f.children(".comment-list").first().remove()) : a("#" + p).remove();
                          var b = a("#comment-form").offset();
                          "undefined" !== typeof b && a("html, body").animate({
                  ...
                  try {
                      a.ajax({
                          ...
                          success: function(b) {
                              ...
                              "undefined" !== typeof TypechoComment && TypechoComment.cancelReply(),
                              ...
                              null === f || 0 === f.length)
                                  ...
                                  g.html(b);
                                  b = a("#comment-" + f, g);
                                  a.trim(b.children(".comment-author").find("cite.fn").text()) === a.trim(m) ? (b.children(".comment-meta").append('<span id="comment-' + f + '-status" class="comment-posted">' + d.attr("data-posted") + "</span>"),
                                  g = b.children(".comment-content"),
                                  g.html(x(g.html(), h.owoData)),
                                  a("#" + p).replaceWith(b),
                                  Mlog("#comment-" + f + " img.avatar[data-src]"),
                                  a("#comment-" + f + " img.avatar[data-src]").each(function() {
                                      var b = a(this);
                                      O(b)
    ...
    , G = function() {
      ...
      !A())) {
          ...
          a("#toggle-menu-tree").off("click").on("click", function(a) {
              b(a)
          });
          r = {};
          a('a.index-menu-link[href^="#menu_index_"]').each(function() {
              ...
              b.match(/menu_index_\d+/) && (a(this).off("click").on("click", function() {
                  ...
                  1E3 > e.innerWidth && (a("#wrap").removeClass("display-menu-tree").removeClass("display-nav"),
                  a("body").removeClass("display-menu-tree").removeClass("display-nav"))
              }),
    ...
    , x = function(a, c) {
      var b, f = "";
      for (void 0 !== e.devicePixelRatio && 1.49 <= e.devicePixelRatio && (f = "_2x"); b = a.match(/@\(\s*(\u5475\u5475|\u54c8\u54c8|\u5410\u820c|\u592a\u5f00\u5fc3|\u7b11\u773c|\u82b1\u5fc3|\u5c0f\u4e56|\u4e56|\u6342\u5634\u7b11|\u6ed1\u7a3d|\u4f60\u61c2\u7684|\u4e0d\u9ad8\u5174|\u6012|\u6c57|\u9ed1\u7ebf|\u6cea|\u771f\u68d2|\u55b7|\u60ca\u54ed|\u9634\u9669|\u9119\u89c6|\u9177|\u554a|\u72c2\u6c57|what|\u7591\u95ee|\u9178\u723d|\u5440\u54a9\u7239|\u59d4\u5c48|\u60ca\u8bb6|\u7761\u89c9|\u7b11\u5c3f|\u6316\u9f3b|\u5410|\u7280\u5229|\u5c0f\u7ea2\u8138|\u61d2\u5f97\u7406|\u52c9\u5f3a|\u7231\u5fc3|\u5fc3\u788e|\u73ab\u7470|\u793c\u7269|\u5f69\u8679|\u592a\u9633|\u661f\u661f\u6708\u4eae|\u94b1\u5e01|\u8336\u676f|\u86cb\u7cd5|\u5927\u62c7\u6307|\u80dc\u5229|haha|OK|\u6c99\u53d1|\u624b\u7eb8|\u9999\u8549|\u4fbf\u4fbf|\u836f\u4e38|\u7ea2\u9886\u5dfe|\u8721\u70db|\u97f3\u4e50|\u706f\u6ce1|\u5f00\u5fc3|\u94b1|\u54a6|\u547c|\u51b7|\u751f\u6c14|\u5f31|\u5410\u8840)\s*\)/); )
          a = a.replace(b[0], '<img src="' + LocalConst.BIAOQING_PAOPAO_PATH + encodeURI(b[1]).replace(/%/g, "") + f + '.png" class="biaoqing newpaopao" height=30 width=30 no-zoom />');
      for (; b = a.match(/#\(\s*(\u9ad8\u5174|\u5c0f\u6012|\u8138\u7ea2|\u5185\u4f24|\u88c5\u5927\u6b3e|\u8d5e\u4e00\u4e2a|\u5bb3\u7f9e|\u6c57|\u5410\u8840\u5012\u5730|\u6df1\u601d|\u4e0d\u9ad8\u5174|\u65e0\u8bed|\u4eb2\u4eb2|\u53e3\u6c34|\u5c34\u5c2c|\u4e2d\u6307|\u60f3\u4e00\u60f3|\u54ed\u6ce3|\u4fbf\u4fbf|\u732e\u82b1|\u76b1\u7709|\u50bb\u7b11|\u72c2\u6c57|\u5410|\u55b7\u6c34|\u770b\u4e0d\u89c1|\u9f13\u638c|\u9634\u6697|\u957f\u8349|\u732e\u9ec4\u74dc|\u90aa\u6076|\u671f\u5f85|\u5f97\u610f|\u5410\u820c|\u55b7\u8840|\u65e0\u6240\u8c13|\u89c2\u5bdf|\u6697\u5730\u89c2\u5bdf|\u80bf\u5305|\u4e2d\u67aa|\u5927\u56e7|\u5472\u7259|\u62a0\u9f3b|\u4e0d\u8bf4\u8bdd|\u54bd\u6c14|\u6b22\u547c|\u9501\u7709|\u8721\u70db|\u5750\u7b49|\u51fb\u638c|\u60ca\u559c|\u559c\u6781\u800c\u6ce3|\u62bd\u70df|\u4e0d\u51fa\u6240\u6599|\u6124\u6012|\u65e0\u5948|\u9ed1\u7ebf|\u6295\u964d|\u770b\u70ed\u95f9|\u6247\u8033\u5149|\u5c0f\u773c\u775b|\u4e2d\u5200)\s*\)/); )
          a = a.replace(b[0], '<img src="' + LocalConst.BIAOQING_ARU_PATH + encodeURI(b[1]).replace(/%/g, "") + f + '.png" class="biaoqing alu" height=33 width=33 no-zoom />');
      a = pa(a, c);
  ...
  var pa = function(a, c) {
      if ("undefined" !== typeof c)
          return a = a.replace(/::([^:]+):([^:]+)::/g, function(a, b, g) {
              var d = c[b];
              if ("undefined" === typeof d || !d.icons.includes(g))
                  return a;
              a = LocalConst.BASE_SCRIPT_URL + "usr/biaoqing/" + d.name + "/";
              var f = d.suffix;
              void 0 != e.devicePixelRatio && 1.49 <= e.devicePixelRatio && (f = d.retinaSuffix);
          ...
          completeFunction: function(b) {
              for (var c = {}, d = 0; d < b.packages.length; d++)
                  if ("usr" === b.odata[b.packages[d]].type) {
                      for (var f = b.odata[b.packages[d]], e = f.container, g = [], m = 0; m < e.length; m++) {
                          var k = e[m];
    ...
    , t = function(a, c, d) {
      ...
      g.cookie = a + "=" + encodeURIComponent(c) + (null === d ? "" : ";expires=" + b.toGMTString()) + ";path=/"
  }
    , M = function() {
    ...
    , H = function() {
      ...
      a("#side-toolbar-read-settings").off("click").on("click", function(b) {
          ...
          b.hasClass("show-read-settings") ? (a(this).parent().removeClass("selected"),
          b.removeClass("show-read-settings")) : (a(this).parent().addClass("selected"),
    ...
    , ha = function() {
      ...
      a("a.background-color-control").off("click").on("click", function(c) {
          ...
          if ("auto" === c) {
              a("a.background-color-control.auto").addClass("selected");
              var d = a("#side-toolbar-night-shift");
              c = (new Date).getHours();
              c <= LocalConst.AUTO_NIGHT_SHIFT_TO || c >= LocalConst.AUTO_NIGHT_SHIFT_FROM || LocalConst.PREFERS_DARK_MODE ? (b.removeClass("theme-white").removeClass("theme-sunset").removeClass("os-dark-mode").addClass("theme-dark").addClass("dark-mode"),
              d.addClass("night"),
              d = "theme-dark",
              (c <= LocalConst.AUTO_NIGHT_SHIFT_TO || c >= LocalConst.AUTO_NIGHT_SHIFT_FROM) && b.removeClass("dark-mode"),
              LocalConst.PREFERS_DARK_MODE && b.addClass("os-dark-mode")) : (b.removeClass("theme-dark").removeClass("dark-mode").removeClass("os-dark-mode").removeClass("theme-sunset").addClass(LocalConst.LIGHT_THEME_CLASS),
              d = "theme-white");
              ...
              "white" === c ? (a("a.background-color-control.white").addClass("selected"),
              b.removeClass("theme-dark").removeClass("dark-mode").removeClass("os-dark-mode").removeClass("theme-sunset").addClass(LocalConst.LIGHT_THEME_CLASS),
              t("MIRAGES_NIGHT_SHIFT_MODE", "DAY"),
              b.trigger("mirages:theme-change", [{
                  auto: !1,
                  theme: "theme-white"
              }])) : "sunset" === c ? (a("a.background-color-control.sunset").addClass("selected"),
              b.removeClass("theme-dark").removeClass("dark-mode").removeClass("os-dark-mode").addClass(LocalConst.LIGHT_THEME_CLASS).addClass("theme-sunset"),
              t("MIRAGES_NIGHT_SHIFT_MODE", "SUNSET"),
              b.trigger("mirages:theme-change", [{
                  auto: !1,
                  theme: "theme-sunset"
              }])) : "dark" === c && (a("a.background-color-control.dark").addClass("selected"),
      ...
      if ("function" === typeof e.matchMedia) {
          var c = e.matchMedia("(prefers-color-scheme: dark)")
            , d = function(c) {
              LocalConst.PREFERS_DARK_MODE = c.matches;
              (c = b.hasClass("use-navbar") ? a("#navbar").find("a.background-color-control.auto") : a("#nav").find("a.background-color-control.auto")) && c.hasClass("selected") && (LocalConst.PREFERS_DARK_MODE ? (b.removeClass("theme-white").addClass("theme-dark").addClass("dark-mode").addClass("os-dark-mode"),
              LocalConst.USE_MIRAGES_DARK && b.removeClass("dark-mode")) : (c = (new Date).getHours(),
              c <= LocalConst.AUTO_NIGHT_SHIFT_TO || c >= LocalConst.AUTO_NIGHT_SHIFT_FROM ? b.removeClass("theme-white").removeClass("dark-mode").removeClass("os-dark-mode").addClass("theme-dark") : b.removeClass("theme-dark").removeClass("dark-mode").removeClass("os-dark-mode").removeClass("theme-white").addClass(LocalConst.LIGHT_THEME_CLASS)))
          };
          "function" === typeof c.addEventListener ? c.addEventListener("change", d) : "function" === typeof c.addListener && c.addListener(d)
      }
  }
    , ia = function() {
          ...
          if ("serif" === b) {
              ...
              if (!h.serifFontLoaded) {
                  if ("undefined" === typeof WebFontConfig) {
                      ...
                      b.href = "https://fonts.googleapis.com/css?family=Noto+Serif+SC:400,700&amp;subset=chinese-simplified,japanese",
              ...
              "sans-serif" === b && (t("MIRAGES_USE_SERIF_FONTS", ""),
    ...
    , ja = function() {
      ...
      (function() {
          ...
          80 > c && (c = LocalConst.ROOT_FONT_SIZE,
          Mlog(LocalConst.ROOT_FONT_SIZE));
          c = Math.round(c);
          b.text(c + "%")
      }
      )();
    ...
    , S = function() {
      a("section.lazy-load").each(function() {
          0 <= e.asyncImageLoadNum && (e.asyncImageLoadNum++,
          ...
          g.onload = function() {
              ...
              setTimeout(function() {
                  a(g).addClass("loaded").attr("data-action", "zoom").removeAttr("no-zoom").removeAttr("width").removeAttr("height").css("height", "").attr("data-shadow", b.attr("data-shadow"));
                  b.replaceWith(a(g));
                  "undefined" !== typeof e[u("Load")] && 1 <= e[u("Load")] && remove(g);
                  0 <= e.asyncImageLoadCompleteNum && (e.asyncImageLoadCompleteNum++,
                  Mlog("Loaded Image: " + e.asyncImageLoadCompleteNum),
                  e.asyncImageLoadCompleteNum === e.asyncImageLoadNum && (e.asyncImageLoadNum = -1170,
    ...
    , T = function() {
      a("article img:not(code img, pre img, .lazy-load img)").each(function() {
          ...
          null !== b && void 0 !== b && "" !== b && (c = getImageAddon(c),
          a(this).attr("src", b + c),
    ...
    , ta = function() {
      try {
          ...
          a(".post-content embed.video, .post-content video.video, .post-content iframe.video").addClass("video-4-3"),
          a(".post-content embed[video], .post-content video[video], .post-content iframe[video]").addClass("video-4-3"),
          a(".post-content embed[video-4-3], .post-content video[video-4-3], .post-content iframe[video-4-3]").addClass("video-4-3"),
          a(".post-content embed[video-16-9], .post-content video[video-16-9], .post-content iframe[video-16-9]").addClass("video-16-9"),
          a(".post-content embed, .post-content video, .post-content iframe").each(function() {
          ...
          a(".post-content embed.video-4-3, .post-content video.video-4-3, .post-content iframe.video-4-3").removeClass("video-16-9").wrap("<div class='video-container video-4-3'></div>"),
          a(".post-content embed.video-16-9, .post-content video.video-16-9, .post-content iframe.video-16-9").wrap("<div class='video-container video-16-9'></div>"),
    ...
    , Y = function() {
      ...
      try {
          a(".search-form-input").on("click focus", function(b) {
              "undefined" !== typeof INSIGHT_CONFIG && (a("body").removeClass("display-nav"),
    ...
    , Z = function() {
      LocalConst.ENABLE_FLOW_CHART && a("pre>code.lang-flow").each(function(b) {
          a(this).addClass("nohighlight").attr("data-flow-chart-index", b).parent().addClass("display-none").after('<div id="flow-chart-' + b + '" class="flow-chart"></div>')
      });
    ...
    , va = function(a) {
      ...
      b.appendChild(d);
      w(LocalConst.BASE_SCRIPT_URL + "static/mathjax/2.7.5/MathJax.js", function() {
    ...
    , qa = function() {
      if (LocalConst.ENABLE_MATH_JAX) {
          var a = function() {
              "undefined" === typeof MathJax ? (Mlog("MathJax undefined."),
              console.error("MathJax undefined.")) : (Mlog("Rendering MathJax..."),
              MathJax.Hub.Queue(["Typeset", MathJax.Hub, "body"]))
          };
          "undefined" === typeof MathJax ? (Mlog("Loading MathJax..."),
          va(function() {
              Mlog("MathJax Loaded.");
              a()
          })) : a()
      ...
      if (LocalConst.ENABLE_FLOW_CHART) {
          var b = function() {
              if ("undefined" === typeof flowchart)
                  Mlog("FlowChart undefined."),
                  console.error("FlowChart undefined.");
              else {
                  ...
                  var d = {
                    ...
                    , b = "white";
                  a("body").hasClass("theme-dark") && (d["line-color"] = "white",
                  d["element-color"] = "white",
                  d["font-color"] = "white",
                  b = "dark");
                  h.flowChartTheme === b ? Mlog("FlowChart Theme Not Change. Skip Render...") : (h.flowChartTheme = b,
                      ...
                      if ("undefined" !== typeof c)
                          try {
                              var b = "flow-chart-" + b
                                ...
                                , h = g.querySelector("#" + b);
                              h ? (h.innerHTML = "",
                              e.drawSVG(b, d)) : console.warn("FlowChart Target: " + b + " Not Exists!")
                          } catch (v) {
                              console.error(v)
                          }
                  }))
          ...
          "undefined" === typeof flowchart ? (Mlog("Loading FlowChart..."),
          wa(function() {
      ...
      if (LocalConst.ENABLE_MERMAID) {
          var b = function() {
              if ("undefined" === typeof mermaid)
                  Mlog("Mermaid undefined."),
                  console.error("Mermaid undefined.");
              else {
                                      ...
                                      if (f) {
                                          ...
                                          4 === f.length) {
                                              var h = parseInt(f[0], 10)
                                                , f = parseInt(f[2], 10) - h;
                                              0 < f && (c.style.maxWidth = f + "px",
                                              c.style.minWidth = .75 * f + "px")
                                          }
                                      } else
                                          f = .75 * parseInt(c.style.maxWidth, 10),
                                          0 < f && (c.style.minWidth = f + "px")
                                  })
                              } catch (v) {
                                  console.error(v),
          ...
          "undefined" === typeof mermaid ? (Mlog("Loading Mermaid..."),
          w(LocalConst.BASE_SCRIPT_URL + "static/mermaid/8.0.0/mermaid.min.js", function() {
              Mlog("Mermaid Loaded.");
              b()
          })) : b()
      }
  ...
  e.Mirages = {
      ...
      version: function() {
          console.log("Mirages.version = " + LocalConst.THEME_VERSION);
          console.log("Mirages.js.version = 7.10.1")
      },
      ...
      doPJAXCompleteAction: function() {
          ...
          isNaN(e.asyncBannerLoadNum) || 0 !== e.asyncBannerLoadNum || (Mlog("Async Banner Nothing to Load"),
          ...
          0 > b || (b = e.location.hash.substring(b + 1),
          R(b));
          G();
          X();
          aa();
          ...
          loadGithubRepos();
          LocalConst.COMMENT_SYSTEM === LocalConst.COMMENT_SYSTEM_DISQUS ? U() : LocalConst.COMMENT_SYSTEM === LocalConst.COMMENT_SYSTEM_EMBED && (J(),
          I())
      }
  };
              ...
              (c = [{
                  ...
                  value: function(e, t) {
                      var n = arguments.length > 2 && void 0 !== arguments[2] && arguments[2]
                        , a = e;
                      if (n && this.isSpecificTag(a, t))
                          return !0;
                      for (; a.parentNode; )
                          if (a = a.parentNode,
                          this.isSpecificTag(a, t))
                              return !0;
                      return !1
                  }
              }, {
                  ...
                  value: function(e) {
                      var t = e;
                      if (t && (this.isSpecificTag(t, this.ignoredTags) || this.isContentEditable(t)))
                          return !0;
                      for (; t.parentNode; )
                          if ((t = t.parentNode) && (this.isSpecificTag(t, this.ignoredTags) || this.isContentEditable(t)))
                              return !0;
                      return !1
                  }
              }, {
                  ...
                  value: function(e, t) {
                      if (t instanceof Node && !(t instanceof DocumentFragment))
                          for (var n, a, i = document.evaluate(e, t, null, XPathResult.ORDERED_NODE_SNAPSHOT_TYPE, null), o = i.snapshotLength - 1; o > -1; --o) {
                              if (n = i.snapshotItem(o),
                              this.isSpecificTag(n.parentNode, this.presentationalTags) && !this.isInsideSpecificTag(n.parentNode, this.ignoredTags)) {
                                  var r = n.parentNode;
                              ...
                              if (this.canIgnoreNode(n))
                                  a = n;
                              else {
                                  var g = this.spacing(n.data);
                                  if (n.data !== g && (n.data = g),
                                  a) {
                                      ...
                                      var d = n.data.toString().substr(-1) + a.data.toString().substr(0, 1)
                                        , h = this.spacing(d);
                                      if (h !== d) {
                                          for (var y = a; y.parentNode && -1 === y.nodeName.search(this.spaceSensitiveTags) && this.isFirstTextChild(y.parentNode, y); )
                                              y = y.parentNode;
                                          for (var v = n; v.parentNode && -1 === v.nodeName.search(this.spaceSensitiveTags) && this.isLastTextChild(v.parentNode, v); )
                                              v = v.parentNode;
                                          ...
                                          if (-1 === v.nodeName.search(this.blockTags))
                                              if (-1 === y.nodeName.search(this.spaceSensitiveTags))
                                                  -1 === y.nodeName.search(this.ignoredTags) && -1 === y.nodeName.search(this.blockTags) && (a.previousSibling ? -1 === a.previousSibling.nodeName.search(this.spaceLikeTags) && (a.data = " ".concat(a.data)) : this.canIgnoreNode(a) || (a.data = " ".concat(a.data)));
                                              else if (-1 === v.nodeName.search(this.spaceSensitiveTags))
                                                  n.data = "".concat(n.data, " ");
                                              else {
                                                  var b = document.createElement("pangu");
                                                  b.innerHTML = " ",
                                                  y.previousSibling ? -1 === y.previousSibling.nodeName.search(this.spaceLikeTags) && y.parentNode.insertBefore(b, y) : y.parentNode.insertBefore(b, y),
          ...
          var a = "\u2e80-\u2eff\u2f00-\u2fdf\u3040-\u309f\u30a0-\u30fa\u30fc-\u30ff\u3100-\u312f\u3200-\u32ff\u3400-\u4dbf\u4e00-\u9fff\uf900-\ufaff"
            ...
            , j = function() {
              ...
              (j = [{
                  ...
                  value: function(e) {
                      if ("string" != typeof e)
                          return console.warn("spacing(text) only accepts string but got ".concat(t(e))),
                          e;
                      if (e.length <= 1 || !i.test(e))
                          return e;
                      var n = this
                        , a = e;
...
(function(h) {
  ...
  function t(H) {
      ...
      else if (H.selector !== "" && H.context === document)
          return H;
      else if (H.attr("id"))
          return h("#" + H.attr("id"));
      else
...
(function(n, p) {
  ...
  function u(a) {
      var b = y(a);
      if (null !== b && !(b.disabled || b.getAttribute("disabled") || b.classList.contains("disabled")))
          if (g.registerEvent(a),
          "touchstart" === a.type && h.delay) {
              var c = !1
              ...
              h.show(a, b),
              v && (b.addEventListener("touchend", h.hide, !1),
  ...
  var l = l || {}
    ...
    , h = {
      ...
      show: function(a, b, c) {
          ...
          b.appendChild(d);
          var e = t(b), f;
          "touches"in a && a.touches.length ? (f = a.touches[0].pageY - e.top,
          e = a.touches[0].pageX - e.left) : (f = a.pageY - e.top,
          e = a.pageX - e.left);
          e = 0 <= e ? e : 0;
          f = 0 <= f ? f : 0;
      ...
      hide: function(a, b) {
          b = b || this;
          for (var c = b.getElementsByClassName("waves-rippling"), d = 0, e = c.length; d < e; d++)
              x(a, b, c[d])
      }
  }
    , z = {
      input: function(a) {
          ...
          if ("i" !== b.tagName.toLowerCase() || !b.classList.contains("waves-effect")) {
              ...
              c.setAttribute("style", "color:" + b.color + ";background:" + b.backgroundColor);
  ...
  l.init = function(a) {
      ...
      v && (b.addEventListener("touchstart", u, !1),
  ...
  l.ripple = function(a, b) {
      ...
      if (c)
          for (var d, e, f, k, g = 0, m = {
              ...
              m.pageY = e,
              h.show(m, d),
              0 <= b.wait && null !== b.wait && setTimeout(l({
                  type: "mouseup",
                  button: 1
              }, d), b.wait)
  }
...
+function(t) {
  ...
  o.prototype._zoom = function(o) {
      ...
      if (e && "IMG" == e.tagName && !this._$body.hasClass("zoom-overlay-open"))
          return o.metaKey || o.ctrlKey ? window.open(o.target.getAttribute("data-original") || o.target.src, "_blank") : void (e.width >= t(window).width() - i.OFFSET || (this._activeZoomClose(!0),
          this._activeZoom = new i(e),
          this._activeZoom.zoomImage(),
          this._$window.on("scroll.zoom", t.proxy(this._scrollHandler, this)),
          this._$document.on("keyup.zoom", t.proxy(this._keyHandler, this)),
          this._$document.on("touchstart.zoom", t.proxy(this._touchStart, this)),
          ...
          "bubbles"in o ? o.bubbles && o.stopPropagation() : o.cancelBubble = !0))
  }
  ,
  o.prototype._activeZoomClose = function(t) {
      this._activeZoom && (t ? this._activeZoom.dispose() : this._activeZoom.close(),
  ...
  o.prototype._touchMove = function(o) {
      Math.abs(o.touches[0].pageY - this._initialTouchPosition) > 10 && (this._activeZoomClose(),
      t(o.target).off("touchmove.zoom"))
  }
  ,
  i.OFFSET = 80,
  i._MAX_WIDTH = 2560,
...
jQuery(document).ready(function(e) {
  window.loadGithubRepos = function() {
      e(".github-widget:not(.loaded)").each(function() {
          var s = e(this), o, u = s.data("repo"), a = u.split("/")[0], f = u.split("/")[1], l = "http://github.com/" + a, c = "http://github.com/" + a + "/" + f;
          o = e('<div class="github-box repo">' + '<div class="github-box-title">' + "<h3>" + '<a class="owner" href="' + l + '" title="' + l + '" target="_blank">' + a + "</a>" + "/" + '<a class="repo" href="' + c + '" title="' + c + '" target="_blank">' + f + "</a>" + "</h3>" + '<div class="github-stats">' + '<a class="watchers" href="' + c + '/stargazers" title="See stars" target="_blank"><i class="fa fa-star" aria-hidden="true"></i><span>?</span></a>' + '<a class="forks" href="' + c + '/network/members" title="See forkers" target="_blank"><i class="fa fa-code-fork" aria-hidden="true"></i><span>?</span></a>' + "</div>" + "</div>" + '<div class="github-box-content">' + '<p class="description"><span></span> \u2014 <a href="' + c + '#readme" target="_blank">Read More</a></p>' + '<p class="link"></p>' + "</div>" + '<div class="github-box-download">' + '<div class="updated"></div>' + '<a class="download" href="' + c + '/zipball/master" title="Get an archive of this repository">Download as zip</a>' + "</div>" + "</div>");
          o.appendTo(s);
          s.addClass("loaded");
          e.ajax({
              ...
              success: function(t) {
                  ...
                  if (n.homepage != null)
                      o.find(".link").append(e("<a />").attr("href", n.homepage).text(n.homepage))
              }
          })
      })
  }
